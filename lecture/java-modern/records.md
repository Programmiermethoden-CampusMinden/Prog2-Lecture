...
-   k2: Ich verstehe, dass die Attribute in Record-Klassen implizit final sind und automatisch angelegt und über den
    Konstruktor gesetzt werden
-   k2: Ich weiss, dass die Getter in Record-Klassen so benannt sind wie die Namen der Komponenten, also keinen Präfix
    'get' haben
...
Schreiben Sie die Klasse `Student` in eine Record-Klasse um. Was müssen Sie zusätzlich noch tun, damit die aktuelle API
erhalten bleibt?
