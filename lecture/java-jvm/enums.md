...
href="https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/enums/v1/Studi.java"}]{.notes}
...
-   Attribute: `final` Attribute können nur einmal gesetzt werden
    ...
    href="https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/enums/FinalDemo.java"}
...
href="https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/enums/v2/Studi.java"}
...
[Demo: enums.v3]{.ex
href="https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/tree/master/markdown/java-jvm/src/enums/v3/"}
...
::: quizzes
-   [Quiz Enumerations (ILIAS)](https://www.hsbi.de/elearning/goto.php?target=tst_1106515&client_id=FH-Bielefeld)
:::
