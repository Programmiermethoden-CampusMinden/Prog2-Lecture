...
[[Beispiel enums.v1.Studi]{.bsp href="https://github.com/Programmiermethoden-CampusMinden/Prog2-Lecture/blob/master/markdown/java-jvm/src/enums/v1/Studi.java"}]{.notes}
...
*   Attribute: `final` Attribute können nur einmal gesetzt werden
    ...
    [Beispiel enums.FinalDemo]{.bsp href="https://github.com/Programmiermethoden-CampusMinden/Prog2-Lecture/blob/master/markdown/java-jvm/src/enums/FinalDemo.java"}
...
[Demo: enums.v2.Studi]{.bsp href="https://github.com/Programmiermethoden-CampusMinden/Prog2-Lecture/blob/master/markdown/java-jvm/src/enums/v2/Studi.java"}
...
[Demo: enums.v3]{.bsp href="https://github.com/Programmiermethoden-CampusMinden/Prog2-Lecture/tree/master/markdown/java-jvm/src/enums/v3/"}
