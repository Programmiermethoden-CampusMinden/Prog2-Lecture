...
Zeichenklasse. In der Tabelle oben (dritte Zeile) würde man dem `def`
noch ein `^` voranstellen und hätte dann die Zeichen "a" bis "z" *ohne*
"d", "e" und "f".

In den [Folien zu dieser
Lektion](https://github.com/Programmiermethoden-CampusMinden/Prog2-Lecture/blob/_beamer/lecture/java-classic/regexp.pdf)
...
<blockquote><p><sup><sub><strong>Last modified:</strong> b5db6aa (lecture: improve learning outcomes (Regexp), 2025-05-22)<br></sub></sup></p></blockquote>
