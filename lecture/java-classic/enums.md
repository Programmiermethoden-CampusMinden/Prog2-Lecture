...
href="https://github.com/Programmiermethoden-CampusMinden/Prog2-Lecture/blob/master/lecture/java-classic/src/enums/v1/Studi.java"}]{.notes}
...
href="https://github.com/Programmiermethoden-CampusMinden/Prog2-Lecture/blob/master/lecture/java-classic/src/enums/v2/Studi.java"}
...
[Demo: enums.v3]{.ex
href="https://github.com/Programmiermethoden-CampusMinden/Prog2-Lecture/tree/master/lecture/java-classic/src/enums/v3/"}
...
-   k3: Ich kann die speziellen Methoden wie `name()`, `ordinal()` und `values()` in
    Enum-Klassen einsetzen
:::
