...
1.  Erweitern Sie die Klasse `Student` um eine *statische* Methode, die zwei
    ...
    in `sort_2b()`. Nutzen Sie dabei eine **Methodenreferenz**.
...
2.  Erweitern Sie die Klasse `Student` um eine Instanz-Methode, die das
    ...
    `sort_3b()`. Nutzen Sie dabei eine **Methodenreferenz**.
:::
