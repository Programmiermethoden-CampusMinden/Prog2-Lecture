...
<blockquote><p><sup><sub><strong>Last modified:</strong> b39b1e7 (lecture: clarify assume (JUnit) vs assert (JUnit) vs assert (Java) (JUnit Basics), 2025-05-23)<br></sub></sup></p></blockquote>
