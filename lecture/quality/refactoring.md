...
::: outcomes
-   k2: Ich kann den Begriff sowie die Notwendigkeit und das Vorgehen des/beim
...
1.  Analysieren Sie den Code und versuchen Sie zu verstehen, was hier passiert.
    Welche Typen müssen die unterschiedlichen Operationen haben (Parametertypen,
    Rückgabetypen)?
...
3.  Kopieren Sie den Code in einen Editor (mit Syntaxunterstützung - die IDE geht
    ...
    und den ursprünglichen Code.

(*Sie brauchen im Dungeon-Projekt nicht zu suchen, diese Code-Stelle ist längst
bereinigt ...*)
