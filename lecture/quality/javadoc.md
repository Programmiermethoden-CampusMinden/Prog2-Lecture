...
>
> - [PDF-Version](https://github.com/Programmiermethoden-CampusMinden/Prog2-Lecture/blob/_pdf/lecture/quality/javadoc.pdf)
>
> </details>
...
- Erste Zeile bei Methoden/Attributen geht in die generierte "Summary"
  ...
  - Die "Summary" sollte kein kompletter Satz sein, wird aber wie ein
    ...
    beginnen mit "Diese Methode macht ..." oder "Diese Klasse ist ...".
    Ein gutes Beispiel wäre "Berechnet die Steuerrückerstattung."
...
von Oracle ([2025](#ref-oraclejavadocguide)).
...
- Oracle ([2025](#ref-oraclejavadocguide))
...
> </div>
>
> <div id="ref-oraclejavadocguide" class="csl-entry">
>
> Oracle. 2025. „How to Write Doc Comments for the Javadoc Tool". 2025.
...
<blockquote><p><sup><sub><strong>Last modified:</strong> b1f3ad0 (lecture: improve learning outcomes (Javadoc), 2025-05-21)<br></sub></sup></p></blockquote>
