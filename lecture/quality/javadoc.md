...
Etwas technisch, aber ebenfalls sehr lesenswert ist der Style-Guide für Java-Software [How to Write Doc Comments for the
Javadoc Tool](https://www.oracle.com/technical-resources/articles/java/javadoc-tool.html) von @oraclejavadocguide.
:::
...
-   k3: Ich kann verschiedene Annotationen zur Dokumentation von Parametern, Rückgabetypen, Exceptions, veralteten
    Elementen einsetzen
...
Vergleichen Sie die Qualität der Dokumentation. Was würden Sie gern in der Dokumentation finden? Was würden Sie ändern?
:::
