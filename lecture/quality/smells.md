...
-   Redundante Kommentare:
    ...
    **beschreiben Sie, was der Code tun *sollte* und *warum***.
    ...
    Beschreiben Sie dabei auch das Konzept hinter einem Codebaustein und gerne auch
    die typische Anwendung der Methode oder Klasse.
    :::
...
::: outcomes
-   k2: Ich kann typische Programmierprinzipien wie 'Information Hiding', 'DRY',
