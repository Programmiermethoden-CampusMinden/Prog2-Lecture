...
-   Anlegen neuer Tests: Klasse auswählen, Kontextmenü `New > JUnit Test Case` [(IJ:
    Kontextmenü `Generate > Test`)]{.notes}
...
-   k3: Ich kann Tests mit JUnit 4 und 5 unter Nutzung der Annotation `@Test`
    erstellen
:::
