...
4.  Implementieren Sie die Testfälle in JUnit (JUnit 4 oder 5).
    ...
    -   Für die ungültigen ÄKs erstellen Sie jeweils eine eigene JUnit-Testmethode. Beachten Sie, dass Sie auch die
...
Das LSF bestimmt mit der Methode `LSF#checkStudentCPS`, ob ein Studierender bereits zur Bachelorarbeit oder Praxisphase
