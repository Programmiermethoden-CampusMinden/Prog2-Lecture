...
![](images/screenshot-gitlabci-pipelines.png)
...
![](images/screenshot-gitlabci-triggeredpipeline.png)
...
![](images/screenshot-gitlabci-job.png)
...
![](images/screenshot-githubci-workflows.png)
...
![](images/screenshot-githubci-triggeredworkflow.png)
...
![](images/screenshot-githubci-job.png)
...
1.  Unter `Settings > Actions > General > Actions permissions` die
    ...
    ![](images/screenshot_github_settings_actions.png)
...
2.  Unter `Settings > Actions > General > Workflow permissions` ggf.
    ...
    ![](images/screenshot_github_settings_permissions.png)
...
3.  Unter `Actions > <WORKFLOW>` den Workflow ggf. deaktivieren:
    ...
    ![](images/screenshot_github_actions.png)
...
<blockquote><p><sup><sub><strong>Last modified:</strong> 79ae063 (lecture: improve learning outcomes (CI), 2025-05-15)<br></sub></sup></p></blockquote>
