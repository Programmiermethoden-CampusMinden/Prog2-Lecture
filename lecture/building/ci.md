...
>
> - [PDF-Version](https://github.com/Programmiermethoden-CampusMinden/Prog2-Lecture/blob/_pdf/lecture/building/ci.pdf)
>
> </details>
...
<img src="images/screenshot-gitlabci-pipelines.png" width="70%">
...
<img src="images/screenshot-gitlabci-triggeredpipeline.png" width="70%">
...
<img src="images/screenshot-gitlabci-job.png" width="70%">
...
<img src="images/screenshot-githubci-workflows.png" width="70%">
...
<img src="images/screenshot-githubci-triggeredworkflow.png" width="70%">
...
<img src="images/screenshot-githubci-job.png" width="70%">
...
1.  Unter `Settings > Actions > General > Actions permissions` die
    ...
    <img src="images/screenshot_github_settings_actions.png" width="70%">
...
2.  Unter `Settings > Actions > General > Workflow permissions` ggf.
    ...
    <img src="images/screenshot_github_settings_permissions.png" width="70%">

3.  Unter `Actions > <WORKFLOW>` den Workflow ggf. deaktivieren:

    <img src="images/screenshot_github_actions.png" width="70%">
...
> <sup><sub>**Last
> modified:** 79ae063 (lecture: improve learning outcomes (CI), 2025-05-15)</sub></sup>
