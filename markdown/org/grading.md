...
Weitere Informationen darüber, wie Sie am Framework mitarbeiten können, finden Sie in der [Core-CONTRIBUTING.md](https://github.com/Programmiermethoden/PM-Dungeon/blob/master/CONTRIBUTING.md).
