...
In der gemeinsamen Vorlesungssitzung wird kein neuer Stoff präsentiert. Wir sprechen
gemeinsam über Ihre Fragen zum aktuellen Thema und werden im Plenum oder in Kleingruppen
...
Wenn bei Ihnen die **praktische Teilleistung** noch offen ist, nehmen Sie entsprechend
am Praktikum teil.

Melden Sie sich für die jeweilige Teilleistung im LSF an.
...
In diesem Semester gibt es einen 2-Wochen-Rhythmus im Praktikum.
...
Sie können Ihre Lösung gern als [Pull-Request] im Dungeon-Repo einreichen. Wenn
Ihr Pull-Request akzeptiert wird, können Sie bis zu 5 Bonuspunkte bekommen
(siehe auch [Bonus-Punkte: Helfen im Framework] in der FAQ).
...
Sie über den Download-Button herunterladen können. Hier ist auch das Feedback
einzutragen.
