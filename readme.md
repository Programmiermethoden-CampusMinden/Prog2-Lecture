...
|  | 16\. | **Station I** 09-11 Uhr, B40 (Aufteilung siehe [Ankündigung](https://github.com/Programmiermethoden-CampusMinden/Prog2-Lecture/discussions/997)) |  |  |
...
Station III im ersten Prüfungszeitraum (Termin wird noch vom Prüfungsamt
bekanntgegeben). Die Punkte der beiden besseren Stationen werden
summiert für die Berechnung der Note.
...
<blockquote><p><sup><sub><strong>Last modified:</strong> 3d4473e (lecture: move logging to quality (Logging), 2025-05-07)<br></sub></sup></p></blockquote>
...
[^3]: **Post Mortem**: Jede Person beschreibt in der ILIAS-Abgabe
    ...
    zum Repo mit der Lösung (erst ab Blatt 04). Siehe auch
