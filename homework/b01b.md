...
Setzen Sie gemeinsam im Team Ihr Konzept aus der [ersten Zyklushälfte](b01a.md) in
...
(s.o.) als **ZIP** in die jeweilige ILIAS-Aufgabe hoch. **Wichtig**: Diese Abgabe
muss aus technischen Gründen bitte **jedes Team-Mitglied einzeln** machen.[^1]
...
Das Feedback muss wieder **einzeln von jedem Team-Mitglied** bearbeitet werden.[^2]
...
anwesend und kann Auskunft geben.[^3]
