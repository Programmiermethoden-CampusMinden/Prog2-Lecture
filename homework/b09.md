...
<!--  pandoc -s -f markdown -t markdown+smart-grid_tables-multiline_tables-simple_tables+four_space_rule --columns=94 --reference-links=true  b09.md  -o xxx.md  -->
...
### A02.2: Nicht-generische Klassen
...
### A02.4: Generische Klassen reloaded
...
### A02.5: Ableiten nicht-generischer Klassen
