...
### A09.2: DevDungeon: Refactoring der Klasse level.devlevel.IllusionRiddleLevel (20%)
...
2.  Beheben Sie die Smells durch die *schrittweise Anwendung*[^3] von den aus der Vorlesung
...
Dokumentation[^4] mit Javadoc.[^5] Während Sie die Dokumentation bei Fehlern manuell anpassen
...
[^4]: zumindest für den syntaktischen Aspekt ...

[^5]: Sie können auch beides zusammen per `./gradlew check` prüfen lassen.
