...
Betrachten Sie Ihre Zoo-Modellierung vom [letzten Blatt](./b07.md): Sie
haben dort eine Typhierarchie für Tiere modelliert mit der Basisklasse
`Animal`, verschiedene generische Klassen zur Repräsentation von Gehegen
erstellt und einen `Zoo`, der letztlich eine Liste von Gehegen
unterschiedlicher Arten enthält und der Hilfsmethoden anbot, um
...
Definieren Sie sich analog zur Vorlesung einen Typ `Result<E,R>`[^1] und
...
[^1]: Sie können die in der Vorlesung erarbeitete Fassung direkt
    übernehmen
