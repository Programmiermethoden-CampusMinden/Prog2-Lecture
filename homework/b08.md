...
<!--  pandoc -s -f markdown -t markdown+smart-grid_tables-multiline_tables-simple_tables --columns=94 --reference-links=true  b10.md  -o xxx.md  -->
...
### A10.1: RegExp mit dem Brücken-Troll
...
### A10.2: Command-Pattern mit der Klasse *BridgeControlCommand*
...
## A10.3: Syntaxhighlighting mit RegExp
