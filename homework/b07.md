...
(Methode), der Zeitstempel sowie die beiden Details der Order (Fahrradtyp, Name des Kunden)
und der Name der betroffenen Datenstruktur ("pendingOrders" oder "completedOrders").
