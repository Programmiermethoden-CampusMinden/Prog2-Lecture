...
Auf diesem Blatt müssen **insgesamt 3 Aufgaben** bearbeitet werden. Zu *jeder*
gewählten Aufgabe sind **alle zugehörigen Teilaufgaben** zu bearbeiten.
...
-   Bearbeiten Sie **entweder** Aufgabe 2 **oder** Aufgabe 3 (mit allen
    Teilaufgaben).
-   Fortgeschrittene sollten **zusätzlich** auch die jeweils andere Aufgabe (2
    oder 3) bearbeiten.
:::
